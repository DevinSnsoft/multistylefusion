...
from core.forward import forward  # 导入前向网络模块
import argparse  # 导入参数选择模块
from core.generateds import center_crop_img
import random
...
# 修改以下5个参数以开启训练
parser.add_argument("--PATH_IMG", type=str, default="./test_imgs/0x4e58.png")  # 参数：选择测试图像
