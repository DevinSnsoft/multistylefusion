...
def get_data_list(mode, path_n=1, with_skel=False, target_font1=None, 
    ...
    # fonts list and char list to sample target image
    if path_n == 1:
        ...
        target_font_L = font_list[K1:]
        target_char_L = char_list[K2:]
    # fonts list and char list to sample style and content images
    font_L = font_list[:K1]
    char_L = char_list[:K2]
...
def get_multi_style_data_list(mode, style_n=3, path_n=1, target_font1=None, target_font2=None,
    ...
    # fonts list and char list of sampling target
    if path_n == 1:
        target_font_L = font_list[:K1]
        target_char_L = char_list[:K2]
    elif path_n == 2:
        ...
        target_font_L = font_list[K1:]
        target_char_L = char_list[K2:]
    # fonts list and char list of sampling style and content
    font_L = font_list[:K1]
    char_L = char_list[:K2]
...
# get_multi_style_data_list('train', style_n=3, path_n=1,target_font1='000', target_font2='001', target_font3='002')
