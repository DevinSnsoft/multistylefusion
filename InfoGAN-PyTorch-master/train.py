...
from models.font_model import Generator, Discriminator, DHead, QHead
...
z = torch.randn(520, params['num_z'], 1, 1, device=device)
fixed_noise = z
print("000000000")
...
if params['num_dis_c'] != 0:
    ...
    dis_c = torch.zeros(520, params['num_dis_c'], params['dis_c_dim'], device=device)
    # print("22222222222")
    print(dis_c.shape)
    print(dis_c.dtype)
    # print(dis_c)
    for i in range(params['num_dis_c']):
        ...
        dis_c[torch.arange(0, 520), i, idx] = 1.0
        # print("333333333333")
        print(dis_c.shape)

    # dis_c = dis_c.view(100, -1, 1, 1)   # view相当于reshape
    dis_c = dis_c.view(520, -1, 1, 1)
...
if params['num_con_c'] != 0:
    ...
    con_c = torch.rand(520, params['num_con_c'], 1, 1, device=device) * 2 - 1
    print("6666666666")
    print(con_c.shape)
...
for epoch in range(params['num_epochs']):
    ...
    for i, (data, _) in enumerate(dataloader, 0):
        ...
        # output1 = sigmoid(output1)  # wjj add
        # output1 = output1.to(torch.float32)  # wjj update
        ...
        for j in range(params['num_dis_c']):
            ...
            # dis_loss += criterionQ_dis(q_logits[:, j * 52: j * 52 + 52], target[j])
